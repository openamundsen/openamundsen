...
def add_default_state_variables(model):
    ...
    meteo.add_variable("wind_speed_gust", "m s-1", "Wind speed of gust", "wind_speed_of_gust")
    ...
    meteo.add_variable(
        "sw_in_clearsky",
        "W m-2",
        "Clear-sky incoming shortwave radiation",
    ...
    meteo.add_variable(
        "diff_in_clearsky",
        "W m-2",
        "Clear-sky diffuse incoming shortwave radiation",
    ...
    soil.add_variable(
        ...
        "1",
        "Fractional frozen soil moisture content",
        dim3=num_soil_layers,
        retain=True,
    )
    soil.add_variable(
        "frac_unfrozen_moisture_content",
        "1",
        "Fractional unfrozen soil moisture content",
        dim3=num_soil_layers,
        retain=True,
    )
