...
def add_default_state_variables(model):
    ...
    meteo.add_variable('snowfall', 'kg m-2 s-1', 'Snowfall flux', 'snowfall')
    meteo.add_variable('rainfall', 'kg m-2 s-1', 'Rainfall flux', 'rainfall')
    meteo.add_variable('precip_amount', 'kg m-2', 'Precipitation amount', 'precipitation_amount')
    meteo.add_variable('snowfall_amount', 'kg m-2', 'Snowfall amount', 'snowfall_amount')
    meteo.add_variable('rainfall_amount', 'kg m-2', 'Rainfall amount', 'rainfall_amount')
    ...
    surf.add_variable('moisture_flux', 'W m-2', 'Moisture flux')
    surf.add_variable('lat_heat', 'J kg-1', 'Latent heat')
    surf.add_variable('sat_vap_press', 'Pa', 'Saturation vapor pressure at surface temperature')
